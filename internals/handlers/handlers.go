...
import (
	...
	"github.com/nayyershahzad/bookings/internals/forms"
	...
	"github.com/nayyershahzad/bookings/internals/repository/dbrepo"
)
...
func (m *Repository) AdminNewReservations(w http.ResponseWriter, r *http.Request) {
	...
	render.Template(w, "admin-new-reservations.page.tmpl", r, &models.TemplateData{Data: data})
}
...
func (m *Repository) AdminAllReservations(w http.ResponseWriter, r *http.Request) {
	...
	data := make(map[string]interface{})
	data["reservations"] = reservations
	render.Template(w, "admin-all-reservations.page.tmpl", r, &models.TemplateData{Data: data})
}
...
func (m *Repository) AdminReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	...
	//assume that no month or year specified
	now := time.Now()
...
func (m *Repository) AdminPostReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	...
	form := forms.New(r.PostForm)
	for _, x := range rooms {
		//get the blockmap from the session. Loop thru entire map , if we have an entry in the map
		//that does not exist in our posted data and if the restriction id is >0 then it is a block we need to remove.
